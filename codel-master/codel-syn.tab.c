...
{
       0,    82,    82,    83,    84,    86,    86,    87,    88,    89,
      90,    91,    94,    94,    94,    95,   108,   108,   109,   113,
     113,   116,   119,   127,   127,   127,   127,   128,   135,   136,
     142,   147,   155,   156,   162,   168,   168,   169,   170,   171,
     172,   175,   175,   177,   178,   178,   179,   180,   180,   182,
     183,   184,   186,   187,   189,   192,   193,   196,   196,   196,
     196,   196,   196,   197,   198,   203,   206,   212,   213,   214,
     214,   215
};
#endif
...
{
  "\"end of file\"", "error", "\"invalid token\"", "BEG", "END", "CONST",
  "TRUE", "FALSE", "BOOL", "INT", "FLOAT", "PLUS", "MINUS", "MULT", "DIV",
  "LESS", "GREATER", "NOTEQUAL", "LESSEQ", "GREATEQ", "EQUAL", "NOT",
  "PARENTH_OPEN", "PARENTH_CLOSE", "BRACKET_OPEN", "BRACKET_CLOSE",
  "ASSIGN_OP", "INTEGER", "REAL", "ID", "COMMA", "COLON", "SEMICOLON",
  "FOR", "IF", "ELSE", "HASHTAG", "UMINUS", "$accept", "start",
...
static const yytype_int8 yydefact[] =
{
      ...
      13,     5,     0,     0,     0,    36,     0,     0,    16,    17,
       ...
       0,    35,     0,    48,     0,    39,     0,    40,     4,     2,
       0,     0,    43,     0,     0,     0,     0,    44,    45,     0,
      30,    34,    29,    41,    42,    47,    46,    38,    37,     0,
...
static const yytype_int8 yypgoto[] =
{
     ...
     -52,   -51,   -25,   -28,    -4,   -52,   -52,   -52,   -52,   -52,
     -43,   -52,   -52,     6,   -52,   -39,   -52,    18,   -52,    -8,
     -52,   -52
};
...
#line 83 "codel-syn.y"
                                                                      {yyyerror("Missing BEG");}
#line 1362 "codel-syn.tab.c"
    break;

  case 4: /* start: declaration_list BEG instruction_list error  */
#line 84 "codel-syn.y"
                                                                      {yyyerror("Missing END");}
#line 1368 "codel-syn.tab.c"
    break;

  case 10: /* declaration: variable_declaration error  */
#line 90 "codel-syn.y"
                                                     { yyyerror("Missing SEMICOLON after variable declaration");}
#line 1374 "codel-syn.tab.c"
    break;

  case 11: /* declaration: constant_declaration error  */
#line 91 "codel-syn.y"
                                                     { yyyerror("Missing SEMICOLON after constant declaration");}
#line 1380 "codel-syn.tab.c"
    break;
...
#line 95 "codel-syn.y"
                        ...
                        for (int i = 0; i < size; i++) {
                            modifier((yyvsp[0].str)[i], (yyvsp[-1].str));
                            free((yyvsp[0].str)[i]);
                        }
                        free((yyvsp[0].str));
                    }
...
#line 109 "codel-syn.y"
   ...
   modifier( (yyvsp[-2].str), (yyvsp[-3].str));
}
#line 1403 "codel-syn.tab.c"
    break;

  case 21: /* identifier_list: ID  */
#line 116 "codel-syn.y"
                    {
...
#line 170 "codel-syn.y"
                                           { yyyerror("Missing SEMICOLON after assign instruction");}
...
#line 184 "codel-syn.y"
                                                                                             { yyyerror("Missing COMMAS in forloop head"); }
#line 1508 "codel-syn.tab.c"
    break;

  case 55: /* condition: PARENTH_OPEN expression_condition PARENTH_CLOSE  */
#line 192 "codel-syn.y"
                                                                       { (yyval.boolean) = (yyvsp[-1].boolean); }
#line 1514 "codel-syn.tab.c"
    break;

  case 56: /* condition: NOT condition  */
#line 193 "codel-syn.y"
                                      { (yyval.boolean) = !(yyvsp[0].boolean); }
#line 1520 "codel-syn.tab.c"
    break;
...
#line 1546 "codel-syn.tab.c"
    break;


#line 1550 "codel-syn.tab.c"
